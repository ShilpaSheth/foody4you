...
class Wallpaper extends Component {
    ...
    locationChangeHandler = (event) => {
        ...
        sessionStorage.setItem('location_id', selectedValue);

        // fetch the restaurants for this location
        axios.get(`${API_URL}/api/getRestaurantsByLocation/${selectedValue}`)
            .then(result => {
                this.setState({
            ...
            <>
                ...
                <div className="topSection">
                    ...
                    <div className="search-options">
                        <select className="location" onChange={this.locationChangeHandler}>
